          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6 text-left">
                Welcome to Zara Restaurant, where culinary excellence meets warm hospitality and quality food. 
                </p>
            ...
            <LinkGroup header="Language">
              <NavLink link="/#" label="English" />
              <NavLink link="/#" label="Tigrinya" />
              <NavLink link="/#" label="Amharic" />
            </LinkGroup>
            <LinkGroup header="Contact Info">
              <NavLink link="/#" label="614 826 1459" />
            </LinkGroup>

            <LinkGroup header="Follow us on">
