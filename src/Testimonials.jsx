          ...
          <Swiper slidesPerView={1} ref={sliderRef}>
            ...
            <SwiperSlide>
              <SingleTestimonial
                ...
                reviewImg=""
                reviewAlt=""
                details="ZARA in Columbus is the real deal. The vibe is chill, the staff are friendly and know their stuff, and the food? It's bursting with flavor, totally legit. If you're into exploring Eritrea and Ethiopian cuisine in Columbus, this spot's where it's at."
                name="Filmon A"
          ...
          <div className="relative mb-12 w-full max-w-[310px] md:mb-0 md:mr-12 md:max-w-[250px] lg:mr-14 lg:max-w-[280px] 2xl:mr-16">
            ...
            <span className="absolute -bottom-6 -right-6 z-[-1]">
              <svg
                ...
                viewBox="0 0 64 64"
                fill="none"
                xmlns="https://www.yelp.com/biz/zara-restaurant-and-bar-columbus?hrid=gwoIJIaJCh2mfL7snZRJzg&utm_campaign=www_review_share_popup&utm_medium=copy_link&utm_source=(direct)
"
              >
                <path
  ...
  return (
    <>
      <svg
        ...
        viewBox="0 0 77 77"
        fill="none"
        xmlns="https://www.yelp.com/biz/zara-restaurant-and-bar-columbus?hrid=IG5AY9EThGnuPpiaUjmhfg&utm_campaign=www_review_share_popup&utm_medium=copy_link&utm_source=(direct)"
      >
        <circle
          cx="1.66343"
          cy="74.5221"
