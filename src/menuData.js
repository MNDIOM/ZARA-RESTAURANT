const menuData = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 205, name: "Banatu", price: 15.99, desc: "Spicy beef ribs served hot with kifto and cottage cheese", imghr: "https://static.spotapps.co/spots/6e/df63e127ee4a7fb0765f90cc1665c9/full"},
        ...
        { id: 211, name: "Bozena Shiro", price: 10.99, desc: "Cubed prime beef simmered with spiced Shiro (ground chickpeas)", imghr: "https://www.wassethiopianrestaurant.com/wp-content/uploads/2021/07/Bozena-Shiro.jpg"},
        { id: 212, name: "Shiro", price: 9.99, desc: "Shiro served plain or with avocado", imghr: "https://a.storyblok.com/f/95452/2000x1500/fbad400f1a/food-shiro-wat.jpg/m/1000x1000/filters:focal(1098x504:1099x505)"},
    ...
    },
   {
      ...
      items: [
        ...
        { id: 303, name: "Kitcha Fitfit", price: 7.99, desc: "Chopped Eritrean traditional flatbread tossed in homemade butter or hot spice berbere and served with yogurt as a topping", imghr: "https://i.imgur.com/gBMgvhm.png"},
        ...
        { id: 305, name: "Egg sandwich", price: 6.99, desc: "Egg sandwich with veggies", imghr: "https://www.allthingsmamma.com/wp-content/uploads/2023/04/egg-and-cheese-sandwich-hero-4-scaled.jpg"},
    ...
    },
   {
      ...
      category: "Pasta",
      items: [
        { id: 401, name: "Vegan Spaghetti or Macaroni", price: 12.99, desc: "Spaghetti or macaroni served with special Zara sauce served with Italian bread rolls", imghr: "https://i.imgur.com/UqtynQz.jpg"},
        { id: 402, name: "Meat Spaghetti or Macaroni", price: 10.99, desc: "Spaghetti or macaroni served with special Zara meat sauce, served with Italian bread rolls", imghr: "https://i.imgur.com/u34DSjg.jpeg"},
        { id: 403, name: "Cotoletta", price: 12.99, desc:"Description needed here from Client/Menu. Additional content to meet 3 lines." , imghr: "https://i.imgur.com/KWkUAyP.jpeg"}
      ]
    },
   {
      id: 5,
      category: "Sandwiches",
      items: [
        { id: 501, name: "Steak Sandwich", price: 8.99, desc: "Grilled steak, onions, tomatoes, swiss cheese, lettuce, ranch dressing", imghr: "https://www.eatthis.com/wp-content/uploads/sites/4/2019/03/subway-steak-and-cheese-sub.jpg?quality=82&strip=1"},
        ...
        { id: 503, name: "Fish Sandwich", price: 8.99, desc: "Grilled fish, onions, tomatoes, swiss cheese, lettuce, ranch dressing", imghr: "https://i0.wp.com/spainonafork.com/wp-content/uploads/2020/06/image4-12-11.png?fit=750%2C750&ssl=1"},
      ]
    },
   {
      id: 6,
      category: "Kids",
      items: [
        { id: 601, name: "Meat Strips & Side", price: 4.99, desc: "Description needed here from Client/Menu. Additional content to meet 3 lines.", imghr: "https://i.imgur.com/ysmUarH.jpg"},
        { id: 602, name: "Spaghetti or Macaroni", price: 4.99, desc: "Description needed here from Client/Menu. Additional content to meet 3 lines.", imghr: "https://i.imgur.com/eBBXcJP.jpg"}
      ]
    },
   {
      id: 7,
