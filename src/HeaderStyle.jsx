            ...
            <div className="w-full px-4 lg:w-5/12">
              <div className="hero-content">
                ...
                <p className="mb-8 max-w-[480px] text-base text-body-color dark:text-dark-6">
                  Welcome to Zara Restaurant, where culinary excellence meets
                  warm hospitality. Nestled in the heart of the city, Zara
                  offers a diverse menu that celebrates both local flavors and
                  international cuisine, crafted with the freshest ingredients.
                </p>
